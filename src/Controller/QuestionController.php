...
use Drupal\chgk\Entity\Question;
...
class QuestionController extends ControllerBase {
   ...
   */
  public function page(Question $chgk_question) {
    $build = $this->buildPage($chgk_question);
    foreach ($chgk_question->uriRelationships() as $rel) {
      // Set the question path as the canonical URL to prevent duplicate content.
   ...
   *   The page title.
   */
  public function pageTitle(Question $chgk_question) {
   ...
   *   An array suitable for drupal_render().
   */
  protected function buildPage(Question $chgk_question) {
